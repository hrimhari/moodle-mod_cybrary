 ...
 *
 *      - int cybraryid: The id of the cybrary which has been subscribed to.
 * }
 *
 * @package    mod_cybrary
 * @since      Moodle 2.7
...
class subscription_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' subscribed the user with id '$this->relateduserid' to the cybrary with " .
    ...
    public static function get_name() {
        return get_string('eventsubscriptioncreated', 'mod_cybrary');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'cybrary', 'subscribe', 'view.php?f=' . $this->other['cybraryid'],
