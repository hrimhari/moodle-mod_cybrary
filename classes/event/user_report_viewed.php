...
/**
 * The mod_cybrary user report viewed event.
 *
 * @package    mod_cybrary
...
/**
 * The mod_cybrary user report viewed event class.
 *
...
class user_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventuserreportviewed', 'mod_cybrary');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/mod/cybrary/user.php', array('id' => $this->relateduserid,
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'cybrary', 'user report', $logurl, $this->relateduserid);
    }
