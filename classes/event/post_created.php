...
/**
 * The mod_cybrary post created event.
 *
 * @package    mod_cybrary
...
/**
 * The mod_cybrary post created event class.
 *
...
class post_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostcreated', 'mod_cybrary');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'cybrary', 'add post', $logurl, $this->other['cybraryid'], $this->contextinstanceid);
    }
