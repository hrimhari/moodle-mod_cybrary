...
/**
 * The mod_cybrary post updated event.
 *
 * @package    mod_cybrary
...
/**
 * The mod_cybrary post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_cybrary');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'cybrary', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
