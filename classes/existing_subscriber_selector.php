 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_cybrary_existing_subscriber_selector extends mod_cybrary_subscriber_selector_base {
    ...
    public function find_users($search) {
        ...
        $params['cybraryid'] = $this->cybraryid;
        ...
        $subscribers = $DB->get_records_sql("SELECT $fields
                                              ...
                                              WHERE $wherecondition AND s.cybrary = :cybraryid
        ...
        return array(get_string("existingsubscribers", 'cybrary') => $subscribers);
    }
